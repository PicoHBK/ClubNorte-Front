  ...
  return (
    <>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full bg-amber-600 hover:bg-amber-500 text-white font-medium py-1.5 rounded-md text-sm transition disabled:opacity-50 flex items-center justify-center gap-2"
                disabled={isUpdating || isDeleting}
              >
      ...
      <Modal
        ...
        description="Se generará una nueva contraseña para este usuario"
        size="md"
      >
