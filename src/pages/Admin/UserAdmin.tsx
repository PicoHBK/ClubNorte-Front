          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="text-center">
                  <h4 className="text-xl font-bold text-white mb-2">Listar Usuarios</h4>
            ...
            >
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="text-center">
                  <h4 className="text-xl font-bold text-white mb-2">Crear Usuario</h4>
                  <p className="text-slate-400 text-sm">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-bold text-white">Listar Usuarios</h3>
                <p className="text-slate-300 text-sm">Administra todos los usuarios del sistema</p>
              </div>
            </div>
            <button
              onClick={handleBack}
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm">Añade un nuevo usuario al sistema</p>
              </div>
            </div>
            <button
              onClick={handleBack}
